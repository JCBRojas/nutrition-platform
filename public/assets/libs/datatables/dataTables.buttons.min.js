                ...
                if (j)
                    if (e.isArray(j)) this._expandButton(a, j, c, d);
                        ...
                        if (p) {
                            ...
                            j.init &&
                                j.init.call(g.button(p.node), g, e(p.node), j);
                            h++;
                        }
                    }
            }
    ...
    e.extend(k, {
        collection: {
            ...
            action: function (a, b, c, d) {
                ...
                f && "absolute" === g
                    ...
                    ? (d._collection.css({
                      ...
                      (f > g || d.dropup) &&
                          d._collection.css(
                              "top",
                              a.top - d._collection.outerHeight() - 5
                          ),
                ...
                d.background &&
                    l.background(!0, d.backgroundClassName, d.fade, i);
                var j = function () {
                ...
                setTimeout(function () {
                    ...
                    e("body")
                        .on("click.dtb-collection", function (a) {
                            ...
                            e(a.target).parents()[b]().filter(d._collection)
                                .length || j();
                        })
